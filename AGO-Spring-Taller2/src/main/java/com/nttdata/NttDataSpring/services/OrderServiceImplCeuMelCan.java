...
@Service("CeuMelCan")
public class OrderServiceImplCeuMelCan implements OrderServiceI {

	@Autowired
	OrderDaoI orderDao;
	
	/**
	 * Servicio para crear un nuevo pedido a Ceuta, Melilla o Canarias
	 * 
	 * @return Order
	 */
	@Override
	...
	/** Servicio para añadir un producto a un pedido a Ceuta, Melilla o Canarias */
	@Override
	public void addProductToOrder(Order o, Product p) {

		if (o != null && p != null) {
			double priceWithTax = p.getPriceNoTax() + p.getPriceNoTax() * 0.04;
	...
	/** Servicio para eliminar un producto de un pedido a Ceuta, Melilla o Canarias */
	@Override
	...
	/**
	 * Servicio para mostrar todos los productos de un pedido a Ceuta, Melilla o Canarias
	 * 
	 * @return List<Product>
	 */
	@Override
	...
	/**
	 * Servicio para mostrar el número de productos de un pedido a Ceuta, Melilla o Canarias
	 * 
	 * @return int
	 */
	@Override
